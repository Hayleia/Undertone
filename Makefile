...
APP_TITLE		:= Undertone
APP_DESCRIPTION		:= Puzzle game with color shades
APP_AUTHOR		:= Hayleia
...
cia: $(TARGET)-strip.elf
	@makerom -f cia -o $(TARGET).cia -elf $(TARGET)-strip.elf -rsf resources/$(TARGET).rsf -exefslogo -target t -icon resources/$(TARGET).icn
	@echo "built cia"
#---------------------------------------------------------------------------------
send: $(BUILD)
	@3dslink $(TARGET).3dsx
